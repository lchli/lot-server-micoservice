package com.lch.lottery.auth.service;

import com.lch.lottery.auth.client.UserClient;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //远程调用用户中心根据账号查询用户信息
        LotUser userext = userClient.getUserext(username);
        if (userext == null) {
